...
function filter_work() {
	...
	$response = get_filtered_work($type_of_work_filter, $offset, $limit);

	wp_die(json_encode(array(
		'html' => $response['html'],
		'total' => $response['filtered_count']
	)));
}


function get_filtered_work($type_of_work_filter = 'all', $offset = 0, $limit = 5) {
                        ...
                        <div class="col-md-6 information">
                            ...
                            <div class="links">
								...
								<?php if ($link_to_github) { ?>
                                    <a class="github" href="<?php echo $link_to_github; ?>" target="_blank">
